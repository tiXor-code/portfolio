  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          className="text-xl md:text-2xl text-apple-gray-300 mb-12 max-w-3xl mx-auto"
          initial={{ opacity: 0, y: 30 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
        >
          Versatile Digital Innovator transforming ideas across industries through adaptive expertise
        </motion.p>
